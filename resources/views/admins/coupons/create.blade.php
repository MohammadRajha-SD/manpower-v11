...
<x-admin-layout>
    ...
    <x-admins.cards.content :name1="__('lang.coupon_table')" :name2="__('lang.coupon_create')"
        route1="admin.coupons.index" route2="admin.coupons.create">
            ...
            <div class="row">
                <div class="d-flex flex-column col-sm-12 col-md-6">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <input type="number" value="{{old('discount')}}" name="discount" class="form-control"
                                placeholder="{{ __("lang.coupon_discount_placeholder") }}" step="any" min="0">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <textarea placeholder="{{ trans("lang.coupon_description_placeholder") }}" name="description" class="form-control" >
                                {!! old('description') !!}
                                </textarea>
                ...
                <div class="d-flex flex-column col-sm-12 col-md-6">
                        ...
                        <div class="col-md-9">
                            <div class="input-group datepicker expires_at" data-target-input="nearest">
                                <input type="text" name="expires_at" class="form-control datetimepicker-input"
                                    ...
                                    data-target=".datepicker.expires_at" data-toggle="datetimepicker"
                                    autocomplete="off"
                    ...
                    <div class="d-flex flex-row  justify-content-start align-items-center">
                        ...
                        <span class="icheck-<?= setting('theme_color'); ?>">
                            <input type="checkbox" name="enabled" value="1" id="enabled" {{old('enabled')=='1'
                                ? 'checked' : '' }}>
