...
<x-admins.sidebar-items :name="__('lang.e_provider_plural')"
    :routes="[['admin.provider*', 'admin.addresses*', 'admin.taxes*', 'provider-schedules*'], 'menu-open']"
...
<x-admins.sidebar-items :name="__('lang.faq_plural')"
    :routes="[['admin.faqs*', 'admin.faq-categories*'], 'menu-open']" icon="fas fa-question-circle">
