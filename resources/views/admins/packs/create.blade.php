            ...
            <div class="row">
                <div class="d-flex flex-column col-sm-12 col-md-6">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <input type="number" id="number_of_ads" name="number_of_ads" class="form-control"
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <select id="type" name="type" class="form-control">
                                <option value="{{trans('lang.companies')}}">{{ trans('lang.companies') }}</option>
                                <option value="{{trans('lang.individuals')}}">{{ trans('lang.individuals') }}</option>
                            </select>
                            <div class="form-text text-muted">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row ">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                <input type="number" name="price" id="price" class="form-control" step="any" min="0"
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <textarea id="description" name="description" class="form-control"
                                placeholder="{{ trans('lang.e_provider_description_placeholder') }}"></textarea>
                            <div class="form-text text-muted">
                ...
                <div class="d-flex flex-column col-sm-12 col-md-6">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <input type="number" id="number_of_subcategories" name="number_of_subcategories"
                                class="form-control"
