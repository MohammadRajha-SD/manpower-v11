...
<x-admin-layout>
    ...
    <x-admins.cards.content :name1="__('lang.partner_table')" :name2="__('lang.partner_create')"
        route1="admin.partners.index" route2="admin.partners.create" :isEditMode="true" :name3="__('lang.partner_edit')"
        :route3="['admin.partners.edit', $partner->id]">
            ...
            <div class="row">
                <div class="d-flex flex-column col-sm-12 col-md-6">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="title" value="{{old('title', $partner->title)}}" id="title" class="form-control"
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <textarea name="description" id="description" class="form-control"
                                placeholder="@lang('lang.category_description_placeholder')">
                                {!! $partner->desc !!}
                            </textarea>
            ...
            <div
                ...
                <div class="d-flex flex-row justify-content-between align-items-center">
                    ...
                    <span class="icheck-{{ setting('theme_color') }}">
                        <input type="checkbox" name="enabled" value="1" id="enabled" {{ $partner->enabled == 1 ? 'checked' : '' }}>
