...
<x-admin-layout>
    ...
    <x-admins.cards.content :name1="__('lang.address_table')" :name2="__('lang.address_create')"
        route1="admin.addresses.index" route2="admin.addresses.create" :isEditMode="true"
        :name3="__('lang.address_edit')" :route3="['admin.addresses.edit', $address->id]">
                        ...
                        <div class="col-md-9">
                            <select name="address" class="form-control select2">
                                ...
                                <optgroup label="{{ $emirate }}">
                                    ...
                                    <option value="{{ $city['slug'] }}" {{ $address->address == $city['slug'] ?
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <textarea name="description" id="description" class="form-control"
                                placeholder="{{ trans('lang.address_description_placeholder') }}">{!! old('description', $address->description) !!}</textarea>
