...
<x-admin-layout>
    ...
    <x-admins.cards.content :name1="__('lang.availability_hour_table')" :name2="__('lang.availability_hour_create')"
        route1="admin.provider-schedules.index" route2="admin.provider-schedules.create">

        <form action="{{route('admin.provider-schedules.store')}}" method="post">
            @csrf
            <div class="row">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group timepicker end_at" data-target-input="nearest">
                                <input type="text" id="end_at" name="end_at" class="form-control datetimepicker-input"
