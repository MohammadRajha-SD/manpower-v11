...
<x-admin-layout>
    ...
    <x-admins.cards.content :name1="__('lang.tax_table')" :name2="__('lang.tax_create')" route1="admin.taxes.index"
        route2="admin.taxes.create" :isEditMode="true" :name3="__('lang.tax_edit')" :route3="['admin.taxes.edit', $tax->id]">
            ...
            <div class="row">
                <div class="d-flex flex-column col-sm-12 col-md-6">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="name" id="name" class="form-control"
                                placeholder="{{ trans('lang.tax_name_placeholder') }}" value="{{ old('name', $tax->name) }}">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <input type="number" name="value" id="value" class="form-control" step="any" min="0"
                            value="{{old('value', $tax->value)}}"
                                placeholder="{{ trans('lang.tax_value_placeholder') }}">
                            <div class="form-text text-muted">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <select name="type" id="type" class="select2 form-control">
                                <option value="percent" {{old('type', $tax->type) == 'percent' ? 'selected' :''}} >{{ trans('lang.tax_percent') }}</option>
                                <option value="fixed" {{old('type', $tax->type) == 'fixed' ? 'selected' :''}} >{{ trans('lang.tax_fixed') }}</option>
                            </select>
