...
<x-admin-layout>
    ...
    <x-admins.cards.content :name1="__('lang.e_service_review_table')" :name2="__('lang.e_service_review_create')"
        ...
        <form action="{{route('admin.service-reviews.store')}}" method="post">
            @csrf
            <div class="row">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <select name="rate" id="rate" class="select2 form-control">
                                ...
                                <option value="{{ $rate }}" {{ old('rate')==$rate ? 'selected' : '' }}>{{ $rate }}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <textarea name="review" id="review" class="form-control"
                                placeholder="{{ trans('lang.e_service_review_review_placeholder') }}">{{ old('review') }}</textarea>
