                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="name" name="name" class="form-control"
                                placeholder="{{ __('lang.currency_name_placeholder') }}" value="{{ old('name', $currency->name) }}">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="symbol" name="symbol" class="form-control"
                                placeholder="{{ __('lang.currency_symbol_placeholder') }}" value="{{ old('symbol',$currency->symbol) }}">
                            <div class="form-text text-muted">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="code" name="code" class="form-control"
                                placeholder="{{ __('lang.currency_code_placeholder') }}" value="{{ old('code', $currency->code) }}">
                            <div class="form-text text-muted">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <input type="number" id="decimal_digits" name="decimal_digits" class="form-control"
                                ...
                                value="{{ old('decimal_digits', $currency->decimal_digits) }}">
                            <div class="form-text text-muted">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <input type="number" id="rounding" name="rounding" class="form-control"
                                ...
                                value="{{ old('rounding',$currency->rounding) }}">
                            <div class="form-text text-muted">
