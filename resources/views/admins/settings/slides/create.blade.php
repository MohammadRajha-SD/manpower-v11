                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="text" name="text" class="form-control"
                                placeholder="{{ trans('lang.slide_text_placeholder') }}" value="{{ old('text') }}">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <textarea id="description" name="description" class="form-control"
                                placeholder="{{ trans('lang.e_provider_description_placeholder') }}">{{ old('description') }}</textarea>
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <select name="status" class="select2 form-control">
                                <option value="1" {{old('status') === 1 ? 'selected' : '' }}>@lang('lang.yes')</option>
                                <option value="0" {{old('status') === 0 ? 'selected' : '' }}>@lang('lang.no')</option>
                            </select>
