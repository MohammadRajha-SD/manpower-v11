...
<x-admin-layout>
    ...
    <x-admins.cards.content :name1="__('lang.subscription_list')" route1="admin.subscriptions.index"
        route2="admin.subscriptions.create" :name2="__('lang.create_subscription')" :isEditMode="true"
        :name3="__('lang.edit_subscription')" :route3="['admin.subscriptions.edit', $subscription->id]">
                    ...
                    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
                        ...
                        <div class="col-md-9">
                            <select name="provider_id" id="provider_id" class="select2 form-control">
                                ...
                                <option value="{{ $provider->id }}" {{ old('provider_id', $subscription->
