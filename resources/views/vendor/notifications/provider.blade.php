...
<tr>
    ...
    <td class="text-right"> {{$provider->email}}</td>
    <td class="text-right"> {{$provider->phone_number}}</td>
</tr>
@endcomponent
{{--@component('mail::panel')--}}
{{--<tr>--}}
...
{{--<tr>--}}
    ...
    {{--<td class="text-right">
        <h3 class="text-right">{!! getPrice($booking->getTotal()) !!}</h3>
    </td>--}}
    {{--</tr>--}}
{{--<tr>--}}
    {{--<td><b>{{__('lang.payment_status')}}</b></td>--}}
    {{--<td class="text-right"><small>{{empty(!$booking->payment) ? $booking->payment->paymentStatus->status :
            '-'}}</small></td>--}}
    {{--</tr>--}}
{{--<tr>--}}
    {{--<td><b>{{__('lang.payment_method')}}</b></td>--}}
    {{--<td class="text-right"><small>{{empty(!$booking->payment) ? $booking->payment->paymentMethod->name :
            '-'}}</small></td>--}}
    {{--</tr>--}}
{{--@endcomponent--}}
{{-- Action Button --}}
